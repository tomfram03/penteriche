  ...
  <div class="row">
    <div class="col-xs-12 col-md-12">
      ...
      <div class="box-general">
        ...
        $id_cliente = $_GET['id'];
		        //echo $id_cliente;
        $result_clientes = "SELECT * FROM clientes WHERE id_clientes='$id_cliente' LIMIT 1";
        $resultado_clientes = mysqli_query($conn, $result_clientes);
        ?>      

        <?php if($resultado_clientes->num_rows <= 0){?>
        <div class="alert alert-danger">
          Não foi possível encontrar o cliente. tente novamente.
        </div>
        <?php } ?>
        ...
        <form class="form-horizontal" method="post" action="<?php echo URL::getBase(); ?>clientes_editar_action">
          ...
          <h1 class="title">Cliente: <?php echo $rows_cursos['nome'];?></h1>
          ...
          <div class="control-group ">
            <div class="form-row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="telephone" class="form-control" id="telefone" name="telefone" value="<?php echo $rows_cursos['telefone'];?>">
              </div>
              <div class="form-group col-md-3">
                <label for="control-label">Celular</label>
                <input type="telephone" class="form-control" name="celular" onkeypress="$(this).mask('(00) 00000-0000')" id="celular" value="<?php echo $rows_cursos['celular'];?>">    
              </div>
              <div class="form-group col-md-3">
                <label for="date">Data de Nascimento</label>
                <input type="text" class="form-control" name="data_nasc" id="date_nasc" value="<?php echo $rows_cursos['data_nasc'];?>">    
              </div> 
            ...
            <div class="control-group ">                
              <div class="form-row">
                <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control" name="profissao" id="profissao" value="<?php echo $rows_cursos['profissao'];?>">
                </div>
                <div class="form-group col-md-2">
                  <label for="control-label">Etnia</label>
                  <input type="text" class="form-control" name="etnia" id="etnia" value="<?php echo $rows_cursos['etnia'];?>">
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="motivoDaVisita" id="motivoDaVisita" value="<?php echo $rows_cursos['motivoDaVisita'];?>">
                </div>            
                <div clas="span10 offset1">
                  ...
                  <div class="control-group ">                
                    <div class="form-row">                
                      <div class="form-group col-md-9">
                        <label for="control-label">Nome Completo</label>
                        <input type="text" class="form-control" id="nome_emerg" name="nome_emerg" value="<?php echo $rows_cursos['nome_emerg'];?>">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="control-label">Telefone</label>
                        <input type="text" class="form-control" name="tel_emerg" value="<?php echo $rows_cursos['tel_emerg'];?>">
                      </div>
                      <div class="form-group col-md-9">
                        <label for="control-label">Médico</label>
                        <input type="text" class="form-control" id="med_emerg" name="med_emerg" value="<?php echo $rows_cursos['med_emerg'];?>">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="control-label">Telefone</label>
                        <input type="text" class="form-control" id="tel_med_emerg" name="tel_med_emerg" pvalue="<?php echo $rows_cursos['tel_med_emerg'];?>">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="control-label">Convênio Médico</label>
                        <input type="text" class="form-control" id="conv_med" name="conv_med" value="<?php echo $rows_cursos['conv_med'];?>">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="control-label">Carteira</label>
                        <input type="text" class="form-control" id="cart_med_emerg" name="cart_med_emerg" value="<?php echo $rows_cursos['cart_med_emerg'];?>">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="control-label">Hospital</label>
                        <input type="text" class="form-control" id="hosp_emerg" name="hosp_emerg" value="<?php echo $rows_cursos['hosp_emerg'];?>">    
                      </div>
                        ...
                        <div class="control-group ">                
                          <div class="form-row">                
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his2" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his2'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his3" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his3'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his4" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his4'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his5" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his5'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his6" value="<?php echo $rows_cursos['resp_his6'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his7" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his7'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his8" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his8'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his9" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his9'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his10" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his10'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his11" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his11'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his12" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his12'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his13" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his13'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his14" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his14'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his15" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his15'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his16" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his16'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his17" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his17'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his18" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his18'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his19" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his19'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his20" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his20'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his21" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his21'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his22" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his22'];?>">
                            </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-4">                      
                              <input type="text" class="form-control" name="resp_his23" id="telefoneMedico" value="<?php echo $rows_cursos['resp_his23'];?>">
                            </div>
