  ...
  <div class="row">
    <div class="col-xs-12 col-md-12">
      ...
      <div class="box-general">
        ...
        <div class="card-body">
          <form class="form-horizontal" action="<?php echo URL::getBase(); ?>clientes_cadastro_action" method="post">
            ...
            <div class="control-group ">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <!--<input id='data' class="form-control" type='date' value='<?php echo date("d/m/Y"); ?>'>-->
                  <input id='data' class="form-control" type='date' value= "">
                ...
                <div class="form-group col-md-5">
                  ...
                  <input type="endereco" class="form-control" name="endereco" id="endereco" placeholder="Endereço">
                </div>
                <div class="form-group col-md-2">
                  <label for="control-label">Número</label>
                  <input type="endereco" class="form-control" name="numero" id="numero" placeholder="Número">
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="telefone" class="form-control" id="telefone" name="telefone" placeholder="Telefone Residencial">
                </div>
                <div class="form-group col-md-3">
                  <label for="control-label">Celular</label>
                  <input type="celular" class="form-control" name="celular" onkeypress="$(this).mask('(00) 00000-0000')" id="celular" placeholder="(15)99999-9999">    
                </div>
                <div class="form-group col-md-3">
                  <label for="date">Data de Nascimento</label>
                  <input type="date_nasc" class="form-control" name="data_nasc" id="date_nasc" name="validade">    
                </div> 
              ...
              <div class="control-group ">                
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <input type="profissao" class="form-control" name="profissao" id="profissao" placeholder="Profissão">
                  </div>
                  <div class="form-group col-md-2">
                    <label for="control-label">Etnia</label>
                    <input type="etnia" class="form-control" name="etnia" id="etnia" placeholder="Etnia">
                  </div>
                  <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="motivoDaVisita" class="form-control" name="motivoDaVisita" id="motivoDaVisita" placeholder="Motivo da Visita">
                  </div>            
                  <div clas="span10 offset1">
                    ...
                    <div class="control-group ">                
                      <div class="row">                
                        <div class="form-group col-md-9">
                          <label for="control-label">Nome Completo</label>
                          <input type="nome" class="form-control" id="nome_emerg" name="nome_emerg" placeholder="Nome Completo">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="control-label">Telefone</label>
                          <input type="telefone" class="form-control" name="tel_emerg" placeholder="Telefone">
                        </div>
                        <div class="form-group col-md-9">
                          <label for="control-label">Médico</label>
                          <input type="medico" class="form-control" id="med_emerg" name="med_emerg" placeholder="Médico">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="control-label">Telefone</label>
                          <input type="telefone" class="form-control" id="tel_med_emerg" name="tel_med_emerg" placeholder="Telefone do Médico">
                        </div>
                        <div class="form-group col-md-6">
                          <label for="control-label">Convênio Médico</label>
                          <input type="convenio" class="form-control" id="conv_med" name="conv_med" placeholder="Convênio Médico">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="control-label">Carteira</label>
                          <input type="carteira" class="form-control" id="cart_med_emerg" name="cart_med_emerg" placeholder="Carteira">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="control-label">Hospital</label>
                          <input type="hospital" class="form-control" id="hosp_emerg" name="hosp_emerg" placeholder="Hospital">    
                        </div>
                          ...
                          <div class="control-group ">                
                            <div class="row">                
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his2" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his3" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his4" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his5" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his6" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his7" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his8" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his9" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his10" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his11" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his12" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his13" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his14" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his15" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his16" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his17" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his18" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his19" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his20" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his21" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his22" id="telefoneMedico" placeholder="Descreva">
                              </div>
                              <div class="form-group col-md-5">
                              ...
                              <div class="form-group col-md-4">                      
                                <input type="telefone" class="form-control" name="resp_his23" id="telefoneMedico" placeholder="Descreva">
                              </div>
                            </div>                        
                            <button type="submit" value="Adicionar" class="btn btn-thema"><i class="fa fa-check"></i> Adicionar</button>
                            <a href="<?php echo URL::getBase(); ?>clientes" type="btn" class="btn btn-primary">Cancelar</a>
                          </div>
                        </div>                
